                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="hero-content">
                                        <div class="section-title">
                                            <h3 class="two-color-text">Welcome to Solor.</h3>
                                            <h1>Power Your Future with Reliable <span>Solar Solutions</span></h1>
                                        </div>

                                        <div class="hero-body">
                                            <p>Duis ultricies, tortor a accumsan fermentum, purus diam mollis velit, eu
                                                bibendum ipsum erat quis leo. Vestibulum finibus, leo dapibus feugiat
                                                rutrum, augue lacus rhoncus velit, vel scelerisque odio est.</p>
                                        </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="hero-image">
                                        <div class="hero-image-box">
                                            ...
                                            <figure>
                                                <img src="images/hero-3-right-img.jpg" alt="">
                                            </figure>
                                        </div>
                                    </div>
		...
		<div class="container-fluid">
			<div class="row no-gap">
				<div class="col-md-12">
					<!-- Section Title Start -->
					<div class="section-title">
						<h3 class="wow fadeInUp two-color-text ">latest project</h3>
						<h2 class="text-anime">Our Latest Work</h2>
					</div>
					<!-- Section Title End -->
				</div>
			</div>
									...
									<div class="project-layout2-slide">
										...
										<div class="project-content">
											...
											<div class="btn-link-box">
												<a href="#"><img src="images/icon-right-2.svg" alt=""></a>
											</div>
										</div>
									</div>
								</div>
		...
		<div class="container">
			<div class="row align-items-center section-title-row">
				<div class="col-lg-6">
					<!-- Section Title Start -->
					<div class="section-title">
						<h3 class="wow fadeInUp two-color-text ">Why Renewable Energy?</h3>
						<h2 class="text-anime">Why do you have to use Solar Panels?</h2>
					</div>
					<!-- Section Title End -->
				</div>
					...
					<div class="why-renewable-left">
						<div class="why-renewable-img-1">
							<figure class="image-anime reveal">
								<img src="images/why-renewable-1.jpg" alt="">
							</figure>
						...
						<div class="why-renewable-img-2">
							...
							<figure class="image-anime reveal">
								<img src="images/why-renewable-2.jpg" alt="">
							</figure>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<!-- Section Title Start -->
					<div class="section-title">
						<h3 class="wow fadeInUp two-color-text ">Our Latest Process</h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
						...
						<div class="why-choose-content">
							...
							<p class="text-white">Ut ut eros risus. In luctus fringilla augue, eget ultricies purus. Sed mauris a nisl.</p>
						</div>
					</div>
					<!-- Why Choose Item End -->
				</div>
